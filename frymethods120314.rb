...
def darkblue(text); colorize(text, 36); end
...
def readText(qxd = 915, qyd = 76, axd =  388, ayd = 42, qx0 = 335, qy0 = 659,  aAx0 = 366, aAy0 = 765, aDx0 = 913, aDy0 = 840)
	r = rand(100000).to_s
	...
	#img = Magick::Image.read('screenshottp1.jpg').first
...
# converts html to plain text as an array of paragraphs
